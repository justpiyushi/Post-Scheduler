...
const AccountList = ({ accounts, onDisconnect }: AccountListProps) => {
  ...
  if (accounts.length === 0)
    return (
      <div className="bg-white rounded-2xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-ceter py-20 px-6">
        ...
        return (
          ...
          >
            <div className="size-12 bg-slate-50 rounded-xl flex items-center justify-center shrink-0">
              <meta.icon className="size-12 bg-slate-50 rounded-xl flex items-center justify-center shrink-0" />
            </div>
